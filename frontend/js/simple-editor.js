...
(function () {
  ...
  function injectCss() {
    ...
    style.textContent = [
      ...
      /* Body */
      '.se-body{min-height:120px;max-height:400px;overflow-y:auto;padding:12px 16px;font-size:11pt;font-weight:500;line-height:1.65;color:#22395a;outline:none;white-space:pre-wrap;word-wrap:break-word;}',
